...
\label{ch: Chapter5}
%======================================================================
In this chapter the implementaion results will be discussed.  First, the setup for the different implementation methods, USB, raspberry pi, and mobile device, are described.  Then, the results for the implementation methods for the different control algorithms are explained.  
%======================================================================
...
\begin{figure}[!htbp]
    ...
    \caption{USB implementation for proportional controller and proportional-integral controller calculated by ADP with a sinusoidal input.}
\end{figure}
