...
\begin{align}
  %\dot{\bf x}(t) = {\bf A}{\bf x}(t) +{\bf B}{\bf u}(t),~\mathrm{where}
    \dot{\bf x}(t) = {\bf A}{\bf x}(t) +{\bf B}{\bf u}(t),~\mathrm{such that}
\label{eq:stateModel}
\end{align}  
%
\begin{align*}
...
\begin{frame}{Simulation}{LQR Simulation (PI Controller)}
    \begin{figure}
      ...
      \caption{LQR Simulation (PI Controller) \subref{fig:Pitch_LQR_Sim}~Pitch~Position and~\subref{fig:Yaw_LQR_Sim}~Yaw~Position w/ Step Input}
...
\begin{frame}{Simulation}{LQR Simulation (PI Controller)}
    \begin{figure}
      ...
      \caption{LQR Simulation (PI Controller) \subref{fig:Pitch_Volt_LQR_Sim}~Pitch~Voltage and~\subref{fig:Yaw_Volt_LQR_Sim}~Yaw~Voltage w/ Step Input}
...
\begin{frame}{Simulation}{LQG Simulation (PI Controller)}
    \begin{figure}
      ...
      \caption{LQG Simulation (PI Controller) \subref{fig:Pitch_LQG_Sim}~Pitch~Position and~\subref{fig:Yaw_LQG_Sim}~Yaw~Position w/ Step Input}
...
\begin{frame}{Simulation}{LQG Simulation (PI Controller)}
    \begin{figure}
      ...
      \caption{LQR Simulation (PI Controller) \subref{fig:Pitch_Volt_LQG_Sim}~Pitch~Voltage and~\subref{fig:Yaw_Volt_LQG_Sim}~Yaw~Voltage w/ Step Input}
...
\subsection{USB}
%
\begin{frame}{Implementation}{ADP and LQR (P Controller) USB}
    \begin{figure}
      \centering
      \subfigure[][]{
      ...
      \caption{USB Implementation comparison between ADP and LQR (P) for \subref{fig:Pitch_LQRvADP_USB}~Pitch and \subref{fig:Yaw_LQRvADP_USB}~Yaw orientations w/ Step Input}
...
\subsection{Android}
%
\begin{frame}{Implementation}{Android}
%    \begin{figure}
%      \centering
%      \subfigure[][]{
%        \label{fig:Pitch_LQRvADP_USB}
