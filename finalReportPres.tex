...
\begin{frame}{Simulation}{Optimal Control Simulation (P Controller)}
    \begin{figure}
      ...
      \caption{Optimal Control (P Controller) Simulation \subref{fig:LQR_Pos_Con}~Position and~\subref{fig:LQR_Volt_Con}~Voltage w/ Step Input}
...
\begin{frame}{Simulation}{Optimal and Noise Resistant Control (PI Controller) Simulation}
    \begin{figure}
      ...
      \caption{Optimal Control (PI Controller) Simulation \subref{fig:Pitch}~Pitch~Position and~\subref{fig:Yaw}~Yaw~Position w/ Step Input}
...
\begin{frame}{Simulation}{Optimal and Noise Resistant Controll (PI Controller) Simulation}
    \begin{figure}
      ...
      \caption{Optimal Control (PI Controller) Simulation \subref{fig:Pitch_Volt}~Pitch~Voltage and~\subref{fig:Yaw_Volt}~Yaw~Voltage w/ Step Input}
...
\begin{frame}{Implementation}{Optimal Control P and PI Controller USB}
    \begin{figure}
      ...
      \caption{USB Implementation comparison between Machine Learning and Optimal Control (P Controller) for \subref{fig:Pitch_LQR_RMSE}~Pitch and \subref{fig:Yaw_LQR_RMSE}~Yaw orientations w/ Step Input}
      \label{fig:PvPI_USB}
    \end{figure}
\end{frame}
%
\begin{frame}{Implementation}{Optimal Control P and PI Controller USB}
    \begin{figure}
      ...
      \caption{USB Implementation comparison between Machine Learning and Optimal Control (P Controller) for \subref{fig:PitchVoltage_LQR_RMSE}~Pitch and \subref{fig:YawVoltage_LQR_RMSE}~Yaw orientations w/ Step Input}
...
\begin{frame}{Implementation}{Machine Learning and Optimal Control (P Controller) USB}
    \begin{figure}
      ...
      \caption{USB Implementation comparison between Machine Learning and Optimal Control (P Controller) for \subref{fig:Pitch_LQRvADP_USB}~Pitch and \subref{fig:Yaw_LQRvADP_USB}~Yaw orientations w/ Step Input}
...
\begin{frame}{Implementation}{Optimal Control (P Controller) via Android}
    \begin{figure}
      ...
      \caption{Optimal Control (P Controller) \subref{fig:LQR_Pitchpos}~Pitch~Position and~\subref{fig:LQR_Yawpos}~Yaw~Position w/ input from Mobile Phone}
      \label{fig:LQR_pos}
    \end{figure}
\end{frame}
%
\begin{frame}{Implementation}{Optimal Control (P Controller) via Android}
    \begin{figure}
      ...
      \caption{Optimal Control (P Controller) \subref{fig:LQR_PitchVolt}~Pitch~Voltage and~\subref{fig:LQR_YawVolt}~Yaw~Voltage w/ input from Mobile Phone}
      \label{fig:LQR_Volt}
    \end{figure}
\end{frame}
%ADP
...
\begin{frame}{Implementation}{Machine Learning via Android}
    \begin{figure}
      ...
      \caption{Optimal Control (P Controller) \subref{fig:ADP_Pitch_Volt_Wireless}~Pitch~Voltage and~\subref{fig:ADP_Yaw_Volt_Wireless}~Yaw~Voltage w/ input from Mobile Phone}
