...
\begin{figure}
    ...
    \fcolorbox{gray!20}{gray!20}{\includegraphics[height=.15\textheight,width=\textwidth,keepaspectratio=true]{figs/ipe/ProblemStatementImage_Gray2.eps}
    }
...
\begin{figure}
    ...
    \subfigure[][]{
    %\missingfigure{Insert figure.}
    \includegraphics[width=.46\textwidth,keepaspectratio=true]{figs/matlab/LQG_LQR_PI_Sim/Pitch}
    \label{fig:simStepPitch}
    }
    \subfigure[][]{
    %\missingfigure{Insert figure.}
    \includegraphics[width=.46\textwidth,keepaspectratio=true]{figs/matlab/LQG_LQR_PI_Sim/Yaw}
    \label{fig:simStepYaw}
    }
    \subfigure[][]{
    %\missingfigure{Insert figure.}
    \includegraphics[width=.46\textwidth,keepaspectratio=true]{figs/matlab/LQG_LQR_PI_Sim/Pitch_Volt}
    \label{fig:simPitchVolt}
    }
    \subfigure[][]{
    %\missingfigure{Insert figure.}
    \includegraphics[width=.46\textwidth,keepaspectratio=true]{figs/matlab/LQG_LQR_PI_Sim/Yaw_Volt}
...
\begin{figure}
    \centering
    \fcolorbox{gray!10}{gray!10}{\includegraphics[height=.15\textheight,width=.9\textwidth,keepaspectratio=true]{figs/ipe/Setup2.eps}}
...
\begin{figure}
    ...
    \subfigure[][]{
    %\missingfigure{Insert figure.}
    \includegraphics[width=.46\textwidth,keepaspectratio=true]{figs/matlab/ADP_USB/Pitch_ADP_LQR2}
    \label{fig:stepPitchADP}
    }
    \subfigure[][]{
    %\missingfigure{Insert figure.}
    \includegraphics[width=.46\textwidth,keepaspectratio=true]{figs/matlab/ADP_USB/Yaw_ADP_LQR2}
...
\begin{figure}
    ...
    \subfigure[][]{
    %\missingfigure{Insert figure.}
    \includegraphics[width=.46\textwidth,keepaspectratio=true]{figs/matlab/LQR_USB/step/Pitch_LQR_RMSE}
    \label{fig:stepPitch}
    }
    \subfigure[][]{
    %\missingfigure{Insert figure.}
    \includegraphics[width=.46\textwidth,keepaspectratio=true]{figs/matlab/LQR_USB/step/Yaw_LQR_RMSE}
    \label{fig:stepYaw}
    }
