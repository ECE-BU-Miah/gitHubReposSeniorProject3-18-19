...
\usepackage[
    pdfauthor={Glenn Janiak and Ken Vonckx}, % Your name for the author field in the PDF
...
\vskip10pt
\HRule \\[0.4cm]
{\Huge \bfseries Laboratory Notebook \\[0.5cm] \Large Smart Control of 2-DoF Helicopters}\\[0.4cm] % Degree
\HRule \\[1.5cm]
\end{center}
}
\author{\Huge Glenn Janiak and \Huge Kenneth Vonckx \\ \\\Large gjaniak@mail.bradley.edu, kvonckx@mail.bradley.edu} % Your name and email address
\date{Beginning August 30, 2018} % Beginning date
\maketitle
...
\labday{Thursday, August 30, 2018}
...
\labday{Tuesday, September 4, 2018}
...
\labday{Thursday, September 6, 2018}
